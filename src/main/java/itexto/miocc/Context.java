...
public class Context {
	...
	/** Construtor que busca todos os dados a partir do stream de entrada */
	public Context(InputStream input) throws ContainerException
	{
		this.beans = new Parser().getBeans(input);
	}
